//
//  GFEmptyFolowerList.swift
//  GitBook
//
//  Created by Lingeswaran Kandasamy on 10/20/21.
//

import UIKit

class GFEmptyFolowerList: UIView {
   ...
   convenience init(message: String) {
    ...
    private func configureMessageLabel() {
        ...
        let messageLabelCentreYConstraint = messageLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: labelCenterYConstant)
